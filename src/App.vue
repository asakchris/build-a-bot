...
export default {
  ...
  computed: {
    ...
    /* Above MapState helper function is shorthand syntax of below functions
    rootFoo() {
    ...
    /* Above MapState helper function is shorthand syntax of below function
    robotsFoo() {
      return this.$store.state.robots.foo;
    }, */
    ...mapGetters({ rootGetterFoo: 'foo' }),
    /* Above MapGetters helper function is shorthand syntax of below function
    rootGetterFoo() {
